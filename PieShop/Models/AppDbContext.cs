...
namespace PieShop.Models
{
    public class AppDbContext:IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //seed categories
            modelBuilder.Entity<Category>().HasData(new Category { CatId = 1, CatName = "Fruit pies" });
            modelBuilder.Entity<Category>().HasData(new Category { CatId = 2, CatName = "Cheese cakes" });
            modelBuilder.Entity<Category>().HasData(new Category { CatId = 3, CatName = "Seasonal pies" });
